...
export default function Home() {
  return (
    <>
      <Header />
      <main className="container md:container mx-auto px-2 md:px-10">
        <h1 className="text-xl md:text-4xl font-bold pt-16">Babymassage</h1>
        <br />
        <div className="flex">
          <p className="text-xs md:text-base flex-1">
            ...
            <menu className="list-disc">
              ...
              <li>
                ...
                komen en makkelijker in slaap vallen.
              </li>
              <li>
          ...
          <img
            src={babyimg}
            className="ml-2 md:mx-12 flex-none max-h-60 md:max-h-80 rounded-2xl"
            alt="Baby Massage"
          />
        </div>
        <hr className="h-px my-8 bg-main border-0" />
        <h2 className="text-base md:text-2xl font-bold">Over mij</h2>
        ...
        <hr className="h-px my-8 bg-main border-0" />
        <h2 className="text-base md:text-2xl font-bold">Cursus volgen</h2>
        <p className="text-xs md:text-base">
